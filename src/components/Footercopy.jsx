...
const Footer = () => {
  return (
    <div className="relative mt-16 bg-secondary2">
      ...
      <div className="px-6 pt-4 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-16 lg:px-12 py-2">
        <div className="grid gap-2 row-gap-0 mb-2 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            ...
            >
              ...
              <span className="ml-4 text-xl font-bold tracking-wide text-blue-500 uppercase">
                DogFood
              </span>
            </a>
